...
public class CommentDAO {
	...
	public List findByExample(Comment instance) {
		...
		try {
			List results = getCurrentSession()
					.createCriteria("demo.vo.Comment")
	...
	public List findByEventid(String eventid) {
		String mysqlstring="select * from Comment where EVENTID = \""+eventid+"\"  order by PUBLISHTIME desc";
		List catNameList =getCurrentSession().createSQLQuery(mysqlstring).addEntity(Comment.class).list();
		return catNameList;
